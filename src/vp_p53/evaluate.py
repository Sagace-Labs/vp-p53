"""Measure a version under an evaluation protocol.
    ...
    python -m vp_p53.evaluate --version v1
...
from vp_p53.train import OUTPUT_LABELS
...
def evaluate_version(
    ...
    *,
    ...
    table = p53_data.example() if use_example else p53_data.load()
    ...
    primary = scored[p53_contract.PRIMARY]
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="python -m vp_p53.evaluate")
    ...
    version = args.version or vp_p53.current_version()
